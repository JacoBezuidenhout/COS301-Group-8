...
>>>>>>> siphokazi
			...
			\begin{itemize}
				...
				\item 	\textbf{View Student Marks [UC1]}\\*
						\textit{Pre-Conditions:}
								\begin{itemize}
									\item Student is registered for module.
								\end{itemize}
								
						\textit{Post-Conditions:}
								\begin{itemize}
									\item Marks viewed added to the Log.
								\end{itemize}
														
				\item	\textbf{View Session Marks [UC2]}\\*
						\textit{Pre-Conditions:}
								\begin{itemize}
									\item Marker is the designated marker for session.
								\end{itemize}
	...
	\section{Glossary}
		...
		\begin{itemize}
			\item UC* - Use Case * (where '*' represents a number)
			\item Pre-Condition - A condition that must be satisfied Before the given use case.
			\item Post-Condition - A condition that must be satisfied After the given use case.
		\end{itemize}
