...
\begin{document}
	...
	\section{Functional Requirements}
		...
		\begin{list}
		{Check validity of user attempting to edit before granting access to edit marks.}
		{Automatic log off of a user if the system is not in use for more than 15 minutes.}
		{Automatic lock after a practical session.}
		{Log-in interface to restrict access to the students enrolled, markers and lecturers involved.}
		{User authentication checks}
		{Students will only be able to view their own marks and no other students' marks when logged in.}
		{Markers will only be able to view students in their session}
		{Only lecturers and markers will be granted access to enter marks into the database.}
		{Only lecturers will obtain a list of all the marks.}
